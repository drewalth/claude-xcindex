...
Sub-millisecond warm queries, ~200× faster than `grep`, reading up to 70%
fewer files. Measured on a real-world Swift project, MacBook Pro M3,
median of 5 runs.
...
**Project:** a real-world Swift project — 302 Swift files, 43,185 LOC,
222 MB on-disk index.
