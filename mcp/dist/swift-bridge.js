...
// SwiftBridge
// ---------------------------------------------------------------------------
const PLUGIN_DIR = path.dirname(path.dirname(fileURLToPath(import.meta.url)) // mcp/dist → mcp
);
const SWIFT_BINARY = path.join(PLUGIN_DIR, "swift-service/.build/release/xcindex");
const SWIFT_BINARY_DEBUG = path.join(PLUGIN_DIR, "swift-service/.build/debug/xcindex");
...
//# sourceMappingURL=swift-bridge.js.map